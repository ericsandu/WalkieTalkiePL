...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[auto, node distance=1.5cm, >=latex', thick]
        ...
        \coordinate (out_mic) at ($(asm.north east)!0.50!(asm.south east)$);
        \coordinate (out_spk) at ($(asm.north east)!0.65!(asm.south east)$);
        \coordinate (out_err) at ($(asm.north east)!0.80!(asm.south east)$);
