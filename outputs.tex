...
\subsection{Implementarea ieșirii de eroare (ERR\_LED)}
...
\subsection{Implementarea ieșirilor de recepție (SPK\_EN, RX\_LED)}
...
\subsection{Implementarea ieșirilor de transmisie (MIC\_EN, TX\_LED)}
