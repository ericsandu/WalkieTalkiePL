\section*{Momentan incorect: to be fixed}
    ...
    \begin{tikzpicture}[font=\footnotesize]
        ...
        \node (tableJ) at (0,0) [anchor=north west] {
            ...
            \begin{tabular}{|c|c|c|}
                ...
                \textbf{00} ($D_0$) & $\bar{P}$ & $H$ \\ \hline
                \textbf{01} ($D_1$) & $0$ & $1$ \\ \hline
        ...
        \foreach \i/\lbl/\val in {
            1.5/00/$\bar{P}\overline{Q_2} + H Q_2$, 
            0.5/01/$Q_2$, 
            -0.5/10/$0$, 
            -1.5/11/$0$
        } {
        ...
        \foreach \i/\lbl/\val in {
            1.5/00/$0$, 
            0.5/01/$Q_2 \bar{T}$, 
            -0.5/10/$\overline{Q_2}\bar{R}\bar{T}$, 
            -1.5/11/$Q_2$
        } {
    ...
    \begin{tikzpicture}[font=\footnotesize]
        ...
        \node (tableK) at (7.5,0) [anchor=north west] {
            ...
            \begin{tabular}{|c|c|c|}
                ...
                \textbf{00} ($D_0$) & $\bar{H}$ & $0$ \\ \hline
                \textbf{01} ($D_1$) & $0$ & $\bar{T}$ \\ \hline
        ...
        \foreach \i/\lbl/\val in {
            1.5/00/$0$,
            0.5/01/$0$,
            -0.5/10/$R\overline{Q_3} + \bar{R}T Q_3$,
            -1.5/11/$0$
        } {
            \draw (muxJ.west) ++(0, \i*\muxPinSpacing) -- node[midway, above, font=\tiny, inner sep=1pt] {\lbl} ++(-0.8, 0) coordinate(startline);
            \node[left, align=right] at (startline) {\small \val};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[font=\footnotesize]
        ...
        \foreach \i/\lbl/\val in {
            1.5/00/$R \overline{Q_0}$, 
            0.5/01/$1$, 
            -0.5/10/$\bar{R} \overline{Q_0}$, 
            -1.5/11/$Q_0$
        } {
            \draw (muxK.west) ++(0, \i*\muxPinSpacing) -- node[midway, above, font=\tiny, inner sep=1pt] {\lbl} ++(-0.8, 0) coordinate(startline);
            \node[left, align=right] at (startline) {\small \val};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[font=\footnotesize]
        ...
        % Intrări
        \foreach \i/\lbl/\val in {
            1.5/00/$P\overline{Q_1} + \bar{R} Q_1$, 
            0.5/01/$H\overline{Q_1}$, 
            -0.5/10/$R Q_1$, 
            -1.5/11/$1$
        } {
            \draw (muxJ.west) ++(0, \i*\muxPinSpacing) -- node[midway, above, font=\tiny, inner sep=1pt] {\lbl} ++(-0.8, 0) coordinate(startline);
