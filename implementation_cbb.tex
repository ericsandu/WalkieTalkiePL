...
\textbf{Selectori:} $Q_1, Q_0$ (Liniile hărții).
Logica intrărilor $D_i$ depinde de $Q_2$ (Coloane).
...
\textbf{Selectori:} $Q_1, Q_0$ (Liniile hărții).
Logica intrărilor $D_i$ depinde de $Q_3$ (Coloane).
...
\textbf{Selectori:} $Q_3, Q_2$ (Coloanele hărții).
Logica intrărilor $D_i$ depinde de $Q_0$ (Linii).
...
\textbf{Selectori:} $Q_3, Q_2$ (Coloanele hărții).
Logica intrărilor $D_i$ depinde de $Q_1$ (Linii).
