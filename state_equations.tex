...
\begin{equation}
  Q_3^+ = Q_3 Q_1 + Q_3 Q_2 \overline{Q_0} +
  Q_3 \overline{Q_2} Q_0 +
  \overline{Q_2} \overline{Q_1} \overline{Q_0} \cdot \overline{P} +
...
Ecuația minimizată extrasă din hartă:
\begin{equation}
  Q_2^+ = Q_2 \overline{Q_1} +
  Q_3 Q_2 \overline{Q_0} +
  \overline{Q_3} \overline{Q_2} Q_1 \cdot R +
  Q_3 Q_1 \overline{Q_0} \cdot \overline{R} T
\end{equation}
...
\begin{equation}
\begin{split}
  Q_1^+ = \overline{Q_3} \overline{Q_1} Q_0 +
  Q_3 \overline{Q_2} \overline{Q_1} +
  Q_3 \overline{Q_2} Q_0 +
  Q_3 Q_2 Q_1 \overline{Q_0} + \\
  Q_3 \overline{Q_2} \cdot R +
  \overline{Q_3} \overline{Q_2} Q_1 \cdot \bar{R} +
  \overline{Q_1} Q_0 \cdot \bar{T} +
  \overline{Q_2} \overline{Q_1} \cdot \bar{P} \bar{C}
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
  Q_0^+ = Q_2 \overline{Q_1} \overline{Q_0} +
  Q_3 Q_2 \overline{Q_0} +
  Q_3 \overline{Q_2} Q_1 \cdot R +
  \overline{Q_3} \overline{Q_2} Q_1 \cdot \bar{R} +
  Q_3 Q_2 \overline{Q_1} \cdot T +
  \overline{Q_3} \overline{Q_1} \overline{Q_0} \cdot P
\end{split}
\end{equation}
